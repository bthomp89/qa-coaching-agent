interface ThemeAnalysisWarningModalProps {
  isOpen: boolean
  onClose: () => void
}

function ThemeAnalysisWarningModal({ isOpen, onClose }: ThemeAnalysisWarningModalProps) {
    ...
    >
      ...
      >
        <div className="px-6 py-4 flex items-center justify-between border-b border-gray-700">
          <h2 className="text-xl font-semibold text-white">Review Required</h2>
          <button
            onClick={onClose}
        ...
        <div className="p-6">
          <p className="text-gray-300">
            You must review the ticket before performing theme analysis.
          </p>
        </div>
...
export default ThemeAnalysisWarningModal
